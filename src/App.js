    ...
    <div className="pt-8 w-full h-screen bg-blue-200">
      <Container>
        <Typography variant="h4" gutterBottom className="text-center mb-8">
          <p className="text-3xl md:text-6xl font-bold">Admin Dashboard</p>
        </Typography>
        <Grid container spacing={4} className="px-4 md:px-0">
          {/* User Management Section */}
          <Grid item xs={12} md={6}>
            <Typography variant="h6" className="text-lg font-semibold mb-4">User Management</Typography>
            <UserTable
              users={users}
              onEditUser={handleEditUser}
              onDeleteUser={handleDeleteUser}
          ...
          {/* Role Management Section */}
          <Grid item xs={12} md={6}>
            <Typography variant="h6" className="text-lg font-semibold mb-4">Role Management</Typography>
            <RoleTable
              roles={roles}
              onEditRolePermissions={handleEditRolePermissions}
            />
